...
- If the user needs a content calendar or topic system, route to `$dks-content`.
- If the writing supports an offer that is unclear, route to `$dks-offer`.
- If the user wants an AI writing workflow, route to `$dks-ai-system`.

## Reference

Deep reference: 知识库/Skill知识包/dks_写作系统.md
