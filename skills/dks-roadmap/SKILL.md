...
- If the roadmap depends on monetization, route to `$dks-offer`.
- If the roadmap depends on publishing, route to `$dks-content`.
- If the roadmap depends on AI workflow design, route to `$dks-ai-system`.

## Reference

Deep reference: 知识库/Skill知识包/dks_一人公司框架.md
